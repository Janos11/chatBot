...
```apache
  <VirtualHost *:80>
      ...
      ProxyPass /api/ollama http://ollama:11434/api/generate
      ProxyPassReverse /api/ollama http://ollama:11434/api/generate

      # Allow necessary headers and methods
      <Location /api/ollama>
          Header set Access-Control-Allow-Origin "http://192.168.1.189:85"
